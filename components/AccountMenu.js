  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        aria-expanded={open}
        className="w-10 h-10 rounded-full border border-black/10 dark:border-white/15 flex items-center justify-center hover:border-gold transition-colors"
      >
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-56 ticket-stub p-2 z-50">
          <Link
            ...
            className="block px-3 py-2.5 rounded-xl hover:bg-cloud dark:hover:bg-white/5 transition-colors"
          >
