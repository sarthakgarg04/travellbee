    ...
    <header className="sticky top-0 z-40 bg-white/90 dark:bg-ink/90 backdrop-blur-md border-b border-black/5 dark:border-white/10">
      ...
      <div className="max-w-6xl mx-auto px-6 py-3 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2.5 ml-auto sm:ml-0">
          <ThemeToggle />
          <a href={PHONE_HREF} className="hidden sm:inline-flex items-center gap-2 bg-gold text-ink text-sm font-semibold px-4 py-2.5 rounded-full hover:bg-ink hover:text-white transition-colors">
